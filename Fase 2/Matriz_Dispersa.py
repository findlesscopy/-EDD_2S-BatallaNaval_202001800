...
class MatrizDispersa():
    ...
    def graficarNeato(self, nombre):
        contenido = '''digraph G{
    node[shape=box, width=0.98, height=0.98, fontname="Arial", fillcolor="white", style=filled]
    edge[style = invis]
    node[label = "capa:''' + str(self.capa) +'''" fillcolor="darkolivegreen1" pos = "-1,1!"]raiz;'''
        ...
        posx = 0
        while pivote != None:
            contenido += '\n\tnode[label = "F{}" fillcolor="antiquewhite2" pos="-1,-{}!" shape=box]x{};'.format(pivote.id, 
            posx, pivote.id)
        ...
        posy = 0
        while pivotey != None:
            contenido += '\n\tnode[label = "C{}" fillcolor="antiquewhite2" pos = "{},1!" shape=box]y{};'.format(pivotey.id, 
            posy, pivotey.id)
        ...
        while pivote != None:
            ...
            while pivote_celda != None:
                ...
                if pivote_celda.caracter == '*':
                    ...
                    contenido += '\n\tnode[label="E" fillcolor="green3" pos="{},-{}!" shape=box]i{}_{};'.format( #pos="{},-{}!"
                        posy_celda, posx, pivote_celda.coordenadaX, pivote_celda.coordenadaY
                    )
                elif pivote_celda.caracter == 'C':
                    contenido += '\n\tnode[label="C" fillcolor="royalblue3" pos="{},-{}!" shape=box]i{}_{};'.format( #pos="{},-{}!"
                        posy_celda, posx, pivote_celda.coordenadaX, pivote_celda.coordenadaY
                    )
    ...
    def graficarSeleccionado(self,nombre):
        
        webbrowser.open("matriz_{}.png".format(nombre))          